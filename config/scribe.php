...
return [
    ...
    'description' => 'Fleepness is a quick-commerce multi-vendor marketplace API. It powers a mobile shopping experience combining product listings, live-stream commerce, short videos, vendor onboarding, order management, and real-time notifications.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token by registering via <code>POST /api/auth/register</code> and verifying your OTP via <code>POST /api/auth/verify-otp</code>. Pass the token as <code>Authorization: Bearer {token}</code>.',
    ],
    ...
    'postman' => [
        ...
        'overrides' => [
            ...
            'info.description' => 'Comprehensive Fleepness API collection covering authentication, catalog browsing, vendor workflows, cart, orders, content, and discovery endpoints. Configure the `baseUrl` and `bearerToken` collection variables before sending protected requests.',
        ],
    ],
